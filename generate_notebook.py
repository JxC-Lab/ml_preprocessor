notebook_content = {
 ...
 "cells": [
  ...
  },
  {
   ...
   "id": "cell-2",
   "metadata": {},
   "source": ["## 1. Generate synthetic dataset"]
  },
  {
   "cell_type": "code",
   "execution_count": None,
  ...
  },
  {
   ...
   "id": "cell-7",
   "metadata": {},
   "source": ["## 3. Build and run the pipeline"]
  },
  {
   "cell_type": "code",
   "execution_count": None,
...
out = Path('/home/claude/example_notebook.ipynb')
out.write_text(json.dumps(notebook_content, indent=1, ensure_ascii=False))
